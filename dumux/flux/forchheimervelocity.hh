  ...
  public:
    ...
    */
                                   ...
                                   const DimWorldVector darcyVelocity)
    {
        ...
        const Scalar forchheimerUpwindMobility = upwind(scvf, elemVolVars, upwindTerm,
    ...
    static Scalar upwind(const SubControlVolumeFace& scvf,
                            const ElementVolumeVariables& elemVolVars,
...
private:
                                      ...
                                      const int phaseIdx)
     {
         ...
         const Scalar rhoOverMu = upwind(scvf, elemVolVars, upwindTerm, insideIsUpstream);

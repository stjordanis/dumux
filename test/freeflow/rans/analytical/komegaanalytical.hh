...
private:
    ...
    Scalar shearStressTensorProduct_(const GlobalPosition& globalPos) const
    {
        ...
        stressTensor[0][0] = 0.5 * (velXGradient_(globalPos)[0] + velXGradient_(globalPos)[0]);
        stressTensor[0][1] = 0.5 * (velXGradient_(globalPos)[1] + velYGradient_(globalPos)[0]);
        stressTensor[1][0] = 0.5 * (velXGradient_(globalPos)[1] + velYGradient_(globalPos)[0]);
        stressTensor[1][1] = 0.5 * (velYGradient_(globalPos)[1] + velYGradient_(globalPos)[1]);
